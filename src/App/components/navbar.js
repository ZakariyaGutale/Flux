        ...
        <div className='end'>
          ...
          <li className='navbar-item'>
            <div className='nav-item-3'>
              <a href='#search-bar'>
              <svg id="search-logo-1" xmlns="http://www.w3.org/2000/svg" fill="transparent" viewBox="0 0 24 24" color="#111827"stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
