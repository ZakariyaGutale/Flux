<h1 style="text-align:center;"><img src="src/App/svg/fluxlogo.svg" alt="Flux Logo" width="auto" height="150px" fill="#4C4C6D"><img src="src/App/svg/Animation1.gif" width="auto" height="300px"></h1>
